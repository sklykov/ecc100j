...
public class Ecc100LibraryDemo
{
  ...
  public void demo() throws InterruptedException
  {
    ...
    for (int i = 0; i < lNumberOfDevicesFound; i++) {
      ...
      controlAproachToTargetPosition(lPointerToDeviceHandle,
                                     i,
                                     lEnable);
      ...
      int epsilon = 1000;
      while (isMoving(lPointerToDeviceHandle, i)
             && abs(getCurrentPosition(lPointerToDeviceHandle, i)
                    - lTargetPosition) > epsilon)
      {
  ...
  private boolean isMoving(Pointer<Integer> pPointerToDeviceHandle,
                           int i)
  {
  ...
  private void singleStep(Pointer<Integer> lPointerToDeviceHandle,
                          int i,
                          boolean lForward)
  {
    EccLibrary.ECC_setSingleStep(lPointerToDeviceHandle.getInt(),
                                 i,
                                 lForward ? 0 : 1);
  }
  ...
  private void setTargetPosition(Pointer<Integer> lPointerToDeviceHandle,
                                 int i,
                                 int lTargetPosition)
  {
    Pointer<Integer> lPointerToTarget = Pointer.allocateInt();
    lPointerToTarget.set(lTargetPosition);
    EccLibrary.ECC_controlTargetPosition(lPointerToDeviceHandle.getInt(),
                                         i,
                                         lPointerToTarget,
                                         1);
    printLastError(lPointerToDeviceHandle, i);
  ...
  private void continuous(Pointer<Integer> lPointerToDeviceHandle,
                          int i,
                          boolean pForward)
  {
    ...
    if (pForward)
      EccLibrary.ECC_controlContinousFwd(lPointerToDeviceHandle.getInt(),
                                         i,
                                         lPointerEnable3,
                                         1);
    else
      EccLibrary.ECC_controlContinousBkwd(lPointerToDeviceHandle.getInt(),
                                          i,
                                          lPointerEnable3,
                                          1);
    printLastError(lPointerToDeviceHandle, i);
  ...
  private void setFrequency(Pointer<Integer> lPointerToDeviceHandle,
                            int i,
                            int lVoltagInMillihertz)
  {
    Pointer<Integer> lPointerToFrequency = Pointer.allocateInt();
    lPointerToFrequency.set(lVoltagInMillihertz);
    EccLibrary.ECC_controlFrequency(lPointerToDeviceHandle.getInt(),
                                    i,
                                    lPointerToFrequency,
                                    1);
    printLastError(lPointerToDeviceHandle, i);
  ...
  private void setVoltage(Pointer<Integer> lPointerToDeviceHandle,
                          int i,
                          int lVoltagInMilliVolts)
  {
    Pointer<Integer> lPointerToAmplitude = Pointer.allocateInt();
    lPointerToAmplitude.set(lVoltagInMilliVolts);
    EccLibrary.ECC_controlAmplitude(lPointerToDeviceHandle.getInt(),
                                    i,
                                    lPointerToAmplitude,
                                    1);
    printLastError(lPointerToDeviceHandle, i);
  ...
  private void stopOnEOT(Pointer<Integer> lPointerToDeviceHandle,
                         int i,
                         boolean pStop)
  {
    Pointer<Integer> lPointerToStopOnEOT = Pointer.allocateInt();
    lPointerToStopOnEOT.set(pStop ? 1 : 0);
    EccLibrary.ECC_controlEotOutputDeactive(lPointerToDeviceHandle.getInt(),
                                            i,
                                            lPointerToStopOnEOT,
                                            1);
    printLastError(lPointerToDeviceHandle, i);
  ...
  private void controlAproachToTargetPosition(Pointer<Integer> lPointerToDeviceHandle,
                                              int i,
                                              boolean lEnable)
  {
    Pointer<Integer> lPointerEnable2 = Pointer.allocateInt();
    lPointerEnable2.set(lEnable ? 1 : 0);
    EccLibrary.ECC_controlMove(lPointerToDeviceHandle.getInt(),
                               i,
                               lPointerEnable2,
                               1);
    printLastError(lPointerToDeviceHandle, i);
  ...
  private void controlOutputRelais(Pointer<Integer> lPointerToDeviceHandle,
                                   int i,
                                   boolean lEnable)
  {
    Pointer<Integer> lPointerEnable1 = Pointer.allocateInt();
    lPointerEnable1.set(lEnable ? 1 : 0);
    EccLibrary.ECC_controlOutput(lPointerToDeviceHandle.getInt(),
                                 i,
                                 lPointerEnable1,
                                 1);
    printLastError(lPointerToDeviceHandle, i);
  ...
  private void connectToDevice(Pointer<Integer> lPointerToDeviceHandle,
                               int i)
  {
    EccLibrary.ECC_Connect(i, lPointerToDeviceHandle);
    System.out.println("deviceHandle="
                       + lPointerToDeviceHandle.getInt());
  }

  private void printActorName(Pointer<Integer> lPointerToDeviceHandle,
                              int i)
  {
    Pointer<Byte> lActorName = Pointer.allocateBytes(128);
    EccLibrary.ECC_getActorName(lPointerToDeviceHandle.getInt(),
                                i,
                                lActorName);
    System.out.println("ECC_getActorName ->"
                       + new String(lActorName.getBytes()));
    printLastError(lPointerToDeviceHandle, i);
  }

  private void printActorType(Pointer<Integer> lPointerToDeviceHandle,
                              int i)
  {
    Pointer<Integer> lActorType = Pointer.allocateInt();
    EccLibrary.ECC_getActorType(lPointerToDeviceHandle.getInt(),
                                i,
                                (Pointer) lActorType);
  ...
  private int getCurrentPosition(Pointer<Integer> lPointerToDeviceHandle,
                                 int i)
  {
    Pointer<Integer> lCurrentPosition = Pointer.allocateInt();
    EccLibrary.ECC_getPosition(lPointerToDeviceHandle.getInt(),
                               i,
                               lCurrentPosition);
    return lCurrentPosition.getInt();
  }

  private void printCurrentPosition(Pointer<Integer> lPointerToDeviceHandle,
                                    int i)
  {
    System.out.println("ECC_getPosition ->"
                       + getCurrentPosition(lPointerToDeviceHandle,
                                            i));
  }

  private void printLastError(Pointer<Integer> lPointerToDeviceHandle,
                              int i)
  {
    Pointer<Integer> lLastError = Pointer.allocateInt();
    EccLibrary.ECC_getStatusError(lPointerToDeviceHandle.getInt(),
                                  i,
                                  lLastError);
