...
public class Ecc100LibraryDemo
{
  ...
  private void continuous(Pointer<Integer> lPointerToDeviceHandle,int i,boolean pForward) {
    ...
    if (pForward)
      EccLibrary.ECC_controlContinousFwd(lPointerToDeviceHandle.getInt(),i,lPointerEnable3,1);
    else
      EccLibrary.ECC_controlContinousBkwd(lPointerToDeviceHandle.getInt(),i,lPointerEnable3,1);
    printLastError(lPointerToDeviceHandle, i);
  }
