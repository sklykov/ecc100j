...
public class Ecc100LibraryDemo
{
	...
	public void demo() throws InterruptedException
	{
		...
		// Thread.sleep(1000);
		Pointer<Pointer<EccInfo>> info = Pointer.allocatePointers(EccInfo.class,
																															4);
		for (int i = 0; i < 4; i++)
		{
		...
		for (int i = 0; i < lNumberOfDevicesFound; i++)
		{
			...
			int epsilon = 1000;
			while (isMoving(lPointerToDeviceHandle, i) && abs(getCurrentPosition(	lPointerToDeviceHandle,
																																						i) - lTargetPosition) > epsilon)
			{
	...
	private void printCurrentPosition(Pointer<Integer> lPointerToDeviceHandle,
																		int i)
	{
		System.out.println("ECC_getPosition ->" + getCurrentPosition(	lPointerToDeviceHandle,
																																	i));
	}
