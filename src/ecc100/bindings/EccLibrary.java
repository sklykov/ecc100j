...
public class EccLibrary {
	 ...
	 */
	@Convention(Convention.Style.StdCall) 
	public static int ECC_controlOutput(int deviceHandle, int axis, Pointer<Integer > enable, int set) {
	 ...
	 */
	@Convention(Convention.Style.StdCall) 
	public static int ECC_getStatusError(int deviceHandle, int axis, Pointer<Integer > error) {
	...
	@Convention(Convention.Style.StdCall) 
	protected native static int ECC_controlTargetRange(int deviceHandle, int axis, @Ptr long range, int set);
	/**
	 * @brief Target status<br>
	 * <br>
	...
	public static int ECC_controlExtTrigger(int deviceHandle, int axis, Pointer<Integer > enable, int set) {
		return ECC_controlExtTrigger(deviceHandle, axis, Pointer.getPeer(enable), set);
	}
	@Convention(Convention.Style.StdCall) 
	protected native static int ECC_controlExtTrigger(int deviceHandle, int axis, @Ptr long enable, int set);
	/**
	...
	public static int ECC_controlAQuadBIn(int deviceHandle, int axis, Pointer<Integer > enable, int set) {
		return ECC_controlAQuadBIn(deviceHandle, axis, Pointer.getPeer(enable), set);
	}
	@Convention(Convention.Style.StdCall) 
	protected native static int ECC_controlAQuadBIn(int deviceHandle, int axis, @Ptr long enable, int set);
	/**
	...
	public static int ECC_controlAQuadBInResolution(int deviceHandle, int axis, Pointer<Integer > resolution, int set) {
		return ECC_controlAQuadBInResolution(deviceHandle, axis, Pointer.getPeer(resolution), set);
	}
	@Convention(Convention.Style.StdCall) 
	protected native static int ECC_controlAQuadBInResolution(int deviceHandle, int axis, @Ptr long resolution, int set);
	/**
	...
	public static int ECC_controlAQuadBOut(int deviceHandle, int axis, Pointer<Integer > enable, int set) {
		return ECC_controlAQuadBOut(deviceHandle, axis, Pointer.getPeer(enable), set);
	}
	@Convention(Convention.Style.StdCall) 
	protected native static int ECC_controlAQuadBOut(int deviceHandle, int axis, @Ptr long enable, int set);
	/**
	...
	public static int ECC_controlAQuadBOutResolution(int deviceHandle, int axis, Pointer<Integer > resolution, int set) {
		return ECC_controlAQuadBOutResolution(deviceHandle, axis, Pointer.getPeer(resolution), set);
	}
	@Convention(Convention.Style.StdCall) 
	protected native static int ECC_controlAQuadBOutResolution(int deviceHandle, int axis, @Ptr long resolution, int set);
	/**
	...
	public static int ECC_controlAQuadBOutClock(int deviceHandle, int axis, Pointer<Integer > clock, int set) {
		return ECC_controlAQuadBOutClock(deviceHandle, axis, Pointer.getPeer(clock), set);
	}
	@Convention(Convention.Style.StdCall) 
	protected native static int ECC_controlAQuadBOutClock(int deviceHandle, int axis, @Ptr long clock, int set);
}
